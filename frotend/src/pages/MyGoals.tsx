          ...
          <div key={goal._id} className={`plan-card ${getStatusColor(goal)}`}>
            <div className="plan-card-content">
              ...
              <div className="plan-preview">
                {goal.result.tasks.slice(0, 3).map((task, idx) => (
                  <div key={idx} className="task-preview">
                    <div className="task-marker"></div>
                    <span>{formatText(cleanContent(task.title))}</span>
                  </div>
                ))}
                {goal.result.tasks.length > 3 && (
                  <div className="more-tasks">+{goal.result.tasks.length - 3} more tasks</div>
                )}
              </div>
            </div>
